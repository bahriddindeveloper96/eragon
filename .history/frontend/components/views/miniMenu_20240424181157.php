                                        ...
                                        <div class="widget widget_nav_menu">
                                            <ul class="menu">
                                                <li class="nav-title menu-item">
                                                    <a href="<?= \yii\helpers\Url::to(['category/view', 'id'=>$child->id]);?>"><?= $child->name_uz;?></a>
                                                </li>
                                                <?php $child = Category::find()->where(['parent_id'=>$child->id])->all();?>
                                                <?php foreach($child as $child_par):?>
                                                    <li class="menu-item"><a href="<?= \yii\helpers\Url::to(['category/view', 'id'=>$child_par->id]);?>"><?= $child_par->name_uz;?></a></li>
                                                <?php endforeach;?>
                                            </ul>
                                                                <!-- .menu -->
                                        </div>
