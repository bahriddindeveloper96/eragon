...
class Category extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name_uz' => Yii::t('common', 'Name Uz'),
            'name_ru' => Yii::t('common', 'Name Ru'),
            'description_uz' => Yii::t('common', 'Description Uz'),
            'description_ru' => Yii::t('common', 'Description Ru'),
            'seo_key_uz' => Yii::t('common', 'Seo Key Uz'),
            'seo_key_ru' => Yii::t('common', 'Seo Key Ru'),
            'seo_desc_uz' => Yii::t('common', 'Seo Desc Uz'),
            'seo_desc_ru' => Yii::t('common', 'Seo Desc Ru'),
