...
class m240131_011427_create_product_value_table extends Migration
{
    ...
    public function safeUp()
    {
       ...
       // $this->createIndex('index-product_value_photo_id', 'product_value', 'photo_id');
        $this->addForeignKey('fkey-product_value_attribute_id', 'product_value', 'attribute_id', 'attribute', 'id', 'CASCADE', 'CASCADE');        
        $this->addForeignKey('fkey-product_value_product_id', 'product_value', 'product_id', 'category_attribute', 'id', 'CASCADE', 'CASCADE');
