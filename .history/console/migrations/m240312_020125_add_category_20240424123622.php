...
class m240312_020125_add_category extends Migration
{
    ...
    {
        $this->batchInsert('{{%category}}', ['id', 'parent_id', 'name_uz','name_ru','description_uz','description_uz','seo_key_uz','seo_key_ru','seo_desc_uz','seo_key_ru','created_by', 'updated_by'], [
