...
class m240312_020125_add_category extends Migration
{
    ...
    public function safeUp()
    {
        $this->batchInsert('{{%category}}', ['id', 'parent_id', 'name_uz','name_ru','description_uz','description_ru','seo_key_uz','seo_key_ru','seo_desc_uz','seo_desc_ru','created_by', 'updated_by'], [
            ...
            [15, NULL, `Uy-rozgor buyumlari`, 'Товары для дома','Uy-ro'zg'or buyumlari`, 'Товары для дома',`Uy-ro'zg'or buyumlari`, 'Товары для дома для eragon.uz','Товары для дома',`Uy-ro'zg'or buyumlari`, 'Товары для дома для eragon.uz', 1, 1],
