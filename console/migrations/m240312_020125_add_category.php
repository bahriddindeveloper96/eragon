...
class m240312_020125_add_category extends Migration
{
    ...
    {
        $this->batchInsert('{{%category}}', ['id', 'parent_id', 'name', 'description', 'created_by', 'updated_by'], [
            [8, NULL, 'Электроника', 'Электроника', 1, 1],
            [9, NULL, 'Бытовая техника', 'Бытовая техника', 1, 1],
            [10, NULL, 'Одежда', 'Одежда', 1, 1],
            [11, NULL, 'Обувь', 'Обувь', 1, 1],
            [12, NULL, 'Аксессуары', 'Аксессуары', 1, 1],
            ...
            [24, 8, 'Ноутбуки, планшеты и электронные книги', 'Ноутбуки, планшеты и электронные книги', 1, 1],
